  ...
  return (
    <Stack spacing={2} direction="row" sx={{ mb: 5 }}>
      <Card sx={{ maxWidth: "100%", paddingBottom: "10%" }}>
        ...
        />
        <CardContent>
          <Typography gutterBottom variant="h5" component="div" sx={{fontFamily: "VerveRegular"}}>
            Lo-fi Push-and-Pull Mechanic Preview #1
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{fontFamily: "Chop", letterSpacing: "1px",}}>
